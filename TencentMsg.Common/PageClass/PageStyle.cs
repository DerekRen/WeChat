...
namespace TencentMsg.Common
{
    class PageStyle
    {
        ...
        /// <returns></returns>
        public static string DisplayPagers(int currentPage, int totalRecord, int perPageCount, string strPage, string urlLink, string title, int flag, bool newMonthed, string strMethod)
        {
            ...
            {
                strJsContent = "javascript:GetOrderList(1,{0});";
            }
